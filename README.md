...
![Library_project](https://github.com/kush-milan/Library-System-Management---Pro/blob/main/library.jpg)
...
- **Database Creation**: Created a database named `milandb2`.
